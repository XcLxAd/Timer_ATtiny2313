...
1 - событие фиксируется, если разрешено индивидуальной настройкой*/
...
#define BUT_PRESSED_CODE        1	// нажатие на кнопку
#define BUT_HELD_CODE           2	// удержание кнопки
#define BUT_RELEASED_CODE       3	// отпускание кнопки после короткого удержания
#define BUT_RELEASED_LONG_CODE  4	// отпускание кнопки после длительного удержания
#define BUT_DOUBLE_CLICK_CODE   5	// быстрое двойное нажатие на кнопку
...
#define BUT_1_LEV    0
#define BUT_1_PULL   1
#define BUT_1_EVENT  (BUT_PRESSED_CODE)
...
#define BUT_2_LEV    0
#define BUT_2_PULL   1
#define BUT_2_EVENT  (BUT_EV_PRESSED|BUT_EV_HELD|BUT_EV_RELEASED_LONG)
...
#define BUT_3_LEV    0
#define BUT_3_PULL   1
#define BUT_3_EVENT  (BUT_EV_PRESSED|BUT_EV_HELD|BUT_EV_RELEASED_LONG)
/*
#define BUT_4_ID     4
